 ...
 */
export async function trackGeneration(success) {
    const now = Date.now();
    // Add to history
...
export function simulateGenerations(count, failRate) {
    const now = Date.now();
...
export function simulateTimeouts(count) {
...
//# sourceMappingURL=generation-alerts.js.map