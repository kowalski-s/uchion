...
- "practice" — задания для самостоятельной работы БЕЗ ответов (content: ["1. Задание ...", "2. Задание ...", "3. Задание ..."])
...
- НЕ оставляй слайды с пустым content — каждый слайд должен содержать контент (минимум 3-4 пункта)
...
- Сразу после каждого слайда "practice" добавь слайд type="content" с title="Ответы" и content с ответами
- ОБЯЗАТЕЛЬНО включи теорию, определения и правила по теме
- ОБЯЗАТЕЛЬНО включи формулы (если они есть в изучаемой теме)`
