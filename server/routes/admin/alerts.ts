...
router.get('/metrics', withAdminAuth(async (req: AuthenticatedRequest, res: Response) => {
  const metrics = getAlertMetrics()
  return res.status(200).json(metrics)
}))

// ==================== POST /api/admin/alerts/reset ====================
router.post('/reset', withAdminAuth(async (req: AuthenticatedRequest, res: Response) => {
  resetAlertState()
...
router.post('/reset-cooldowns', withAdminAuth(async (req: AuthenticatedRequest, res: Response) => {
  resetCooldowns()
...
router.post('/test/error-rate', withAdminAuth(async (req: AuthenticatedRequest, res: Response) => {
...
router.post('/test/timeout', withAdminAuth(async (req: AuthenticatedRequest, res: Response) => {
...
router.post('/test/low-quality', withAdminAuth(async (req: AuthenticatedRequest, res: Response) => {
