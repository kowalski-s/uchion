 ...
 */
function deepToStringObject(obj) {
 ...
 * 5. HMAC-SHA256
 */
export function createProdamusSignature(data, secretKey) {
 ...
 */
function buildQueryString(data, parentKey) {
    const parts = [];
    if (Array.isArray(data)) {
 ...
 */
export function generatePaymentLink(payformUrl, data, secretKey) {
 ...
 */
export function verifyWebhookSignature(payload, signature, secretKey) {
...
//# sourceMappingURL=prodamus.js.map