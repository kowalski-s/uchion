...
- ОБЯЗАТЕЛЬНО делить текст на короткие абзацы.
- Выделять **жирным шрифтом** ключевые термины, правила или формулы (только самое важное).
- Пример(ы) оформлять отдельным предложением на новой строке.
- ЗАПРЕЩЕНО использовать списки (только абзацы).
