 ...
 */
export function encryptProviderId(providerId) {
    if (!providerId)
        return '';
    if (isEncrypted(providerId))
        return providerId;
 ...
 */
export function decryptProviderId(encryptedProviderId) {
    if (!encryptedProviderId)
        return '';
    if (!isEncrypted(encryptedProviderId))
