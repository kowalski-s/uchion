...
const grade7 = {
    ...
    promptHint: 'Седьмой класс алгебры: линейные функции и уравнения, степени с натуральным показателем, одночлены и многочлены.',
};
const grade8 = {
    grade: 8,
    ...
    promptHint: 'Восьмой класс алгебры: квадратные уравнения и функции, алгебраические дроби, неравенства. Иррациональные числа.',
};
const grade9 = {
    grade: 9,
    ...
    promptHint: 'Девятый класс алгебры: прогрессии, системы неравенств, свойства функций. Элементы комбинаторики и теории вероятностей.',
};
const grade10 = {
    grade: 10,
    ...
    promptHint: 'Десятый класс алгебры: тригонометрия (функции, уравнения, формулы), степени с рациональным показателем.',
};
const grade11 = {
    grade: 11,
    ...
    promptHint: 'Одиннадцатый класс алгебры: логарифмы, производная и интегралы, уравнения с параметром. Подготовка к ЕГЭ.',
};
