...
DO $$ BEGIN ALTER TABLE "refresh_tokens" ADD COLUMN "family_id" varchar(255); EXCEPTION WHEN duplicate_column THEN NULL; END $$;--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "refresh_tokens_family_id_idx" ON "refresh_tokens" USING btree ("family_id");
