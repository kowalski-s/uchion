...
### 🔴 AI Cost Management
- [ ] **AI cost мониторинг:** логирование стоимости каждой генерации (tokens, model, cost) (отложено)
- [ ] **Dashboard с AI spending analytics** (для админа - отложено)
- [x] **Бесплатные лимиты консервативно:** 5 генерации всего у новых юзеров бесплатно

### Платежная логика
- [x] Логика лимитов
- [x] Интеграция Prodamus
- [x] Обработка webhook
- [x] **Webhook idempotency** (защита от дублирования платежей)
...
### Улучшение генерации
- [x] Разбить на 3 уровня сложности
- [ ] Перегенерация отдельного задания (ключевая фича)
- [x] Выбор типов заданий через UI (единственный/множественный выбор, соотнесение и т.д.)
