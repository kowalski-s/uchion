...
SUMMARY → CHEATSHEET → ASSIGNMENTS (8 заданий) → TEST (5 вопросов A/B/C) → ANSWERS_ASSIGNMENTS → ANSWERS_TEST.

Требования:
- SUMMARY: 3–4 абзаца, выделяй **жирным** ключевые правила, примеры отдельным абзацем.
- CHEATSHEET: 3–6 кратких пунктов.
- ASSIGNMENTS: ровно 8 заданий — понимание, применение, поиск 1 ошибки, творческое. 1 задание = 1 действие. Нельзя начинать задание словом «Пример:».
...
SUMMARY → CHEATSHEET → ASSIGNMENTS (8 заданий) → TEST (5 вопросов) → ANSWERS_ASSIGNMENTS → ANSWERS_TEST.

SUMMARY — 3–4 абзаца, примеры отдельно, важное выделяй **жирным**.
CHEATSHEET — 3–6 коротких пунктов.
ASSIGNMENTS — 8 заданий: задания на понимание, применение, поиск 1 ошибки, текстовая/комбинированная. Следи, чтобы в сумме было **ровно 8 заданий**. 1 задание = 1 действие. Только числа и приёмы из программы 1–4 класса.
...
Перед выводом сверяй все вычисления, корректность типов заданий, совпадение количества вопросов/ответов и то, что блок ASSIGNMENTS содержит ровно 8 заданий.
`.trim();
...
- задания: ровно 8, 1 действие, нет «Пример:» вместо задания, №3 содержит одну конкретную ошибку;
- тест: 5 вопросов, по 3 варианта, 1 правильный;
- ответы: 8 + 5, соответствуют заданиям;
...
- задания: 8, 1 действие, корректные числа, №3 содержит одну ошибку;
